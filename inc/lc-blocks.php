...
function acf_blocks()
{
    if (function_exists('acf_register_block_type')) {
        ...
        acf_register_block_type(array(
            'name'				=> 'lc_notification',
            'title'				=> __('LC Notification'),
            'category'			=> 'layout',
            'icon'				=> 'cover-image',
            'render_template'	=> 'page-templates/blocks/lc_notification.php',
            'keywords'			=> array( 'notification' ),
            'mode'	=> 'edit',
            'supports' => array('mode' => false),
        ));
        acf_register_block_type(array(
            'name'				=> 'lc_countdown',
            'title'				=> __('LC Countdown'),
            'category'			=> 'layout',
            'icon'				=> 'cover-image',
            'render_template'	=> 'page-templates/blocks/lc_countdown.php',
